...
.desvanecer:hover {
  ...
  transition: opacity 500ms;
	...
	if(!empty($_POST['buscar'])){
		...
		if($count>=1){
			...
			echo "	</tr>
				...
				<tbody>
					<tr>
						<form method='post' action='../Views/app_filtro.php' value=".$result['id_local']. "id='chequeo'>
						...
						<td class='text-left'><a href='../Views/app_filtro.php?id_local=".$result['id_local']."'><input type='submit' value='Ver disponibilidad' name='Disponibilidad' form='chequeo'/></a></td><br>
					</tr>
					<tr>";
	...
	//Pintar tabla de los locales
        ...
        <br>
		<br>
			<h2>¿Quieres darte de alta como local?</h2>
		<br>
		<br>
			<div class="div-imagen">
  				<div class="textoImagen">
					...
					<br>
					<br>
					<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Formulario para darse de alta como nuevo local<h3>
  				</div>
  				<a href="../Controllers/peticionLocales.php"><img class="desvanecer" src="../Resources/pictures/alta_local.jpg"></a>
			</div>
		<br>
		<br>
		<br>
