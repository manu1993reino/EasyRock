...
*/
	...
	<body class="todo" style="font-family: Mochiy Pop P One">
		<div id="panel_menu">
			...
			<a href="../Controllers/alta_local_admin.php"><span class="spanMenu">Dar de alta local &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img class="imgMenu" src="../Resources/pictures/plus.png"></span></a><a href="../Views/app_reserva_admin.php">
			...
			<a href="../Views/app_cierre.php">Cierre de sesión<span class="spanMenu">Cierre de sesión &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img class="imgMenu" src="../Resources/pictures/icon-cerrar-sesion-rojo.png"></span></a>		
		</div>
        <?php
		$sql="use easyrock;";
		$conn->exec($sql);
