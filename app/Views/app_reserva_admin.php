...
.footer-distributed{
	...
	<div id="panel_menu">
		...
		<br>
		<br>
		<h2>Aqui puedes ver todas las reservas activas ahora mismo</h2>
		<hr>
		<br>
		<h2>Si quieres ver disponibilidad de locales para realizar reserva pulsa <a href="../Views/app_locales_admin.php" style='color:blue';>aqui</a></h2>		
<?php
    $sql="use easyrock";
    $conn->exec($sql);
	$resultado = "SELECT DISTINCT * FROM reservas_locales ORDER BY hour(hora_inicio) ASC, fecha;";
	...
	if(!empty($todo)){
		...
		echo "<table class='table-fill'>
			...
			?>
				...
				echo "<h3 style='color:green; z-index:101';>Ningun usario tiene ninguna reserva activa</h3>"; 
		} 
			?>
<?php
