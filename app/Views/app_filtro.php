...
<style>
    ...
    border: none;
    background: #349915;
    box-shadow: 0 5px #32770e;
    }
.btnBuscar:hover {
    box-shadow: 0 3px #32770e;
    top: 1px;
    }
.btnBuscar:active {
    box-shadow: 0 0 #32770e;
    top: 5px;
    }
...
<?php 
    ...
    <?php
        ...
        ?>
    <form class="verReservas" action="../Views/app_reserva.php"><input type="submit" name="Reservas" value="Ver tus reservas"></form>
    ...
    echo "<span style='background-color:black; color:red; font-size:30px; position:absolute; left:700px; top:500px; z-index:10'>Horario no disponible</span><br>";
        ...
        <body>
                <div style='position:absolute; top:800px'>
                    <form style='position:absolute; left:700px; top: 60px;' id='formularioReserva' action='https://formsubmit.co/ajax/$CorreoReservaEmail' method='POST'>
                        ...
                        <input class='btnBuscar' type='submit' name='btnEnviarReserva' value='Confirmar reserva'>
                    </form>
                    ...
                    <form style='position:absolute; left:900px; top: 60px;' action='../Controllers/confirmar_O_Anular.php?id_reserva=$emailEnviar[id_reserva]' method='POST' value='$emailEnviar[id_reserva]'>
                        <input type='hidden' name='valor' value='$emailEnviar[id_reserva]'>
                        <input type='hidden' name='local' value='$codigo'>
                        <input class='btnEliminar' type='submit' name='AnularRes' value='Rechazar reserva'>
                    </form> 
                </div>
            </div>
        </body>
